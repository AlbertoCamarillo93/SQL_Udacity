/* 1. For each account, determine the average amount of each type of paper they purchased across their orders. 
    ...
    SELECT a.name, AVG(o.standard_qty) AS standar_AVG, AVG(o.gloss_qty) AS gloss_AVG, AVG(o.poster_qty) AS poster_AVG
    FROM orders o
    JOIN accounts a
...
/* 2. For each account, determine the average amount spent per order on each paper type. Your result should have four 
    ...
    SELECT a.name, AVG(o.standard_amt_usd) AS standar_AVG, AVG(o.gloss_amt_usd) AS gloss_AVG, AVG(o.poster_amt_usd) AS poster_AVG
    FROM orders o
    JOIN accounts a
    ON a.id = o.account_id
    GROUP BY a.name
