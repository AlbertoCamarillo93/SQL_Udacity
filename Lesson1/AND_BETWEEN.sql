...
orders where gloss_qty is between 24 and 29. Then look at your output to
see if the BETWEEN operator included the begin and end values or not.*/
SELECT *
FROM orders
WHERE gloss_qty BETWEEN 24 AND 29
ORDER BY gloss_qty ASC, occurred_at DESC;
